...
import { BulletinPager } from "./BulletinPager";
...
export function MethodologyBulletin() {
  ...
  return (
    <div className="bulletin-page fade-up">
      ...
      {/* One sheet of paper on a desk. Every band — classification strip,
          masthead, dateline, the headline — lives inside it, so the whole
          bulletin shares one left and right margin. The masthead used to sit
          outside this box, which is why the header ran full-bleed while the
          body was inset. */}
