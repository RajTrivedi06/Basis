...
# Complete set of ARM regions observed in the retail feed (2026-07-30 corpus
# audit). Gov-cloud and Extended Zone entries map geography only —
# purchasability is out of scope for region normalization.
AZURE_REGION_MAP: dict[str, tuple[str, str | None]] = {
    ...
    "westcentralus": ("US", "Wyoming"),
    "westus": ("US", "California"),
    "westus2": ("US", "Washington"),
    "westus3": ("US", "Arizona"),
    "usgovvirginia": ("US", "Virginia"),
    "usgovarizona": ("US", "Arizona"),
    "attatlanta1": ("US", "Atlanta"),
    "attdallas1": ("US", "Dallas"),
    "canadacentral": ("CA", "Ontario"),
    "canadaeast": ("CA", "Quebec City"),
    ...
    "switzerlandwest": ("CH", "Geneva"),
    "israelcentral": ("IL", None),
    "qatarcentral": ("QA", "Doha"),
    "uaenorth": ("AE", "Dubai"),
    "uaecentral": ("AE", "Abu Dhabi"),
    "southafricanorth": ("ZA", "Johannesburg"),
    "southafricawest": ("ZA", "Cape Town"),
    "indonesiacentral": ("ID", "Jakarta"),
    "malaysiawest": ("MY", "Kuala Lumpur"),
    "japaneast": ("JP", "Tokyo"),
    "japanwest": ("JP", "Osaka"),
    ...
    "sgxsingapore1": ("SG", "Singapore"),
    "australiaeast": ("AU", "New South Wales"),
    "australiacentral": ("AU", "Canberra"),
    "australiacentral2": ("AU", "Canberra"),
    "centralindia": ("IN", "Pune"),
    "southindia": ("IN", "Chennai"),
    "jioindiacentral": ("IN", "Nagpur"),
    "jioindiawest": ("IN", "Jamnagar"),
}
